...
CondFunc('torch.Tensor.new', lambda orig, self, *args, **kwargs: orig(self.cpu(), *args, **kwargs).to(torch.dml.default_device()), lambda orig, self, *args, **kwargs: torch.dml.is_directml_device(self.device))
